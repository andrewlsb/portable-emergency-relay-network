...
SERIAL_PORT = "/dev/cu.usbserial-0001"   # CHANGE THIS LATER
BAUD_RATE = 115200


def parse_packet(line):
    """
    Expected RYLR998 format:

    +RCV=<sender>,<length>,<payload>,<RSSI>,<SNR>

    Example:

    +RCV=0,23,GPS,47.66776,-122.31289,-35,11
    """
...
def main():
    ...
    try:
        ...
        print(error)
        print("\nThe SERIAL_PORT value will need to be changed")
        print("after the CP2102 is connected.")
